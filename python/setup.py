...
def find_umfpack():
    ...
    library_dirs = []
    libraries = ['umfpack', 'amd', 'cholmod', 'colamd',
                 'suitesparseconfig', 'blas', 'lapack']

    search_paths = [
        '/usr/local', '/usr', '/opt/homebrew', '/opt/local',
    ...
    for var, lst in [('UMFPACK_INCLUDE', include_dirs),
                     ('UMFPACK_LIB', library_dirs)]:
